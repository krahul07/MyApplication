...
/*
 * AndroidFlavorAdapter is an ArrayAdapter that can provide the layout for each list item
 * based on a user defined data source, which is a list of AndroidFlavor objects.
 * */
